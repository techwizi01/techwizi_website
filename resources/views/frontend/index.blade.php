                    ...
                    <div class="content-column col-lg-8 col-md-12 col-sm-12">
                        <div class="inner-column">
                            ...
                            <div class="sec-title">
                                ...
                                <h2>Our Core <span>Values</span> And <br> Principles.</h2>
                            </div>
                            <div class="row clearfix">
                                                            ...
                                                            <div class="skills">
                                                                ...
                                                                <div class="skill-item">
                                                                    <div class="skill-header clearfix">
                                                                        <div class="skill-title">Digital Strategy
                                                                        </div>
                                                                    </div>
                                                                    <div class="skill-bar">
                                                                        <div class="bar-inner">
                                                                ...
                                                                <div class="skill-item">
                                                                    <div class="skill-header clearfix">
                                                                        <div class="skill-title">Financial Services
                                                                        </div>
                                                                    </div>
                                                                    <div class="skill-bar">
                                                                        <div class="bar-inner">
                        ...
                        <div class="inner-column">
                            <ul class="info-list">
                                ...
                                <li>
                                    ...
                                    <a href="mailto:deanna.curtis@example.com"><span
                                            class="icon fas fa-comment"></span>deanna.curtis@example.com</a><br>
                                    <a href="tel:+406-555-0120"><span class="icon fas fa-phone"></span>(406)
                                        555-0120</a>
                                </li>
                            </ul>
                            <div class="opening">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                        <div class="radio-box">
                                            ...
                                            <label for="type-1">Save my name, email, and website in this browser for
    ...
    <section class="cta-section">
        <div class="auto-container">
            <div class="inner-container clearfix">
                ...
                <div class="pull-right">
                    <div class="button-box">
                        <a href="contact.html" class="theme-btn btn-style-five"><span class="txt">Get quate now <i
                                    class="flaticon-next-2"></i></span></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="inner-column">
                        ...
                        <div class="testimonial-carousel-three owl-carousel owl-theme">
                            ...
                            <div class="testimonial-block">
                                <div class="inner-box">
                                    <div class="text"><span class="quote-left fas fa-quote-left"></span>The other
                                        hand we denounce with righteou indg ation and dislike men who are so
                                        beguiled and demorali ed by the of pleasure of the moment.Dislike men who
                                        are so beguiled and demoraliz worlds ed by the charms of pleasure of the
                                        moment. Lorem ipsum dolor sit amet, consectetur adipiscing elit.<span
                                            class="quote-right fas fa-quote-right"></span></div>
                ...
                <div class="news-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        ...
                        <div class="lower-content">
                            ...
                            <h3><a href="blog-detail.html">Facebook design is dedicated to what's new in design</a>
                            </h3>
