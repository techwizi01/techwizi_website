        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <span class="badge bg-success me-1"> +11% </span> <span class="text-muted">From
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <span class="badge bg-danger me-1"> -29% </span> <span class="text-muted">From
                        previous period</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <span class="badge bg-warning me-1"> 0% </span> <span class="text-muted">From
                        previous period</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <span class="badge bg-success me-1"> +89% </span> <span class="text-muted">Last
                        year</span>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="dropdown float-end position-relative">
                        <a href="#" class="dropdown-toggle h4 text-muted" data-bs-toggle="dropdown"
                            aria-expanded="false">
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-subtitle mb-4 font-size-13 overflow-hidden">Transaction period from
                        21 July to 25 Aug
                    </p>
