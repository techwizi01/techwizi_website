    ...
    <div class="topbar">
        ...
        <ul class="topbar-menu d-flex align-items-center gap-4">
            ...
            <li class="dropdown d-none d-md-inline-block">
                <a class="nav-link dropdown-toggle waves-effect waves-light arrow-none" data-bs-toggle="dropdown"
                    href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <img src="{{ asset('assets/backend') }}/images/flags/us.jpg" alt="user-image" class="me-0 me-sm-1"
                        height="18">
                </a>
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown"
                    href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <img src="{{ asset('assets/backend/images/users/avatar-4.jpg') }}" alt="user-image"
